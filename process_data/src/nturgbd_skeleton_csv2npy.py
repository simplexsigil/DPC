...
# user_name = 'user'
save_npy_path = os.path.expanduser("~/datasets/nturgbd/skeleton_npy/")
load_txt_path = os.path.expanduser("~/datasets/nturgbd/skeleton_csv/")
missing_file_path = os.path.expanduser("~/datasets/nturgbd/missing_skeletons.txt")
