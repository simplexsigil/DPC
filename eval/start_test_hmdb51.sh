...
log_file=log_files/_temp_test_pretrained_nturgbd_test_hmdb51_all_splits.log
log_file_training=log_files/_temp_test_pretrained_nturgbd_test_hmdb51_all_splits_training.log
...
network_split_2="/home/dschneider/workspace/DPC/eval/20200615084144_log_pt_nturgbd_cont_transfer_hmdb51_sp_2_ep_200_ft/hmdb51-128-sp2_r18_lc_cont_bs20_lr0.0001_wd0.001_ds1_seq1_len30_dp0.5_train-ft_pt=pretrained_net/model/model_best_epoch157.pth.tar"
...
date >> $log_file
python3 test.py --dataset hmdb51 --split 2 --seq_len 30 --num_seq 1 --ds 1 --num_workers 16 --gpu 1 --test $network_split_2 # >> $log_file_training
